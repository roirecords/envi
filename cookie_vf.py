...
"}")
        ...
        self.time_s1_lbl.setGeometry(QtCore.QRect(290, 50, 71, 31))
        self.time_s1_lbl.setText("")
        ...
        self.time_s1_lbl_2.setGeometry(QtCore.QRect(260, 50, 41, 31))
        ...
        self.time_s2_lbl.setGeometry(QtCore.QRect(290, 50, 71, 31))
        self.time_s2_lbl.setText("")
        self.time_s2_lbl.setAlignment(QtCore.Qt.AlignCenter)
        self.time_s2_lbl.setObjectName("time_s2_lbl")
        self.time_s2_lbl_2 = QtWidgets.QLabel(self.groupBox_5)
        self.time_s2_lbl_2.setGeometry(QtCore.QRect(260, 50, 41, 31))
        self.time_s2_lbl_2.setAlignment(QtCore.Qt.AlignCenter)
        self.time_s2_lbl_2.setObjectName("time_s2_lbl_2")
        ...
        self.time_s3_lbl.setGeometry(QtCore.QRect(290, 50, 71, 31))
        self.time_s3_lbl.setText("")
        self.time_s3_lbl.setAlignment(QtCore.Qt.AlignCenter)
        self.time_s3_lbl.setObjectName("time_s3_lbl")
        self.time_s3_lbl_2 = QtWidgets.QLabel(self.groupBox_6)
        self.time_s3_lbl_2.setGeometry(QtCore.QRect(260, 50, 41, 31))
        self.time_s3_lbl_2.setAlignment(QtCore.Qt.AlignCenter)
        self.time_s3_lbl_2.setObjectName("time_s3_lbl_2")
    ...
    def retranslateUi(self, Form):
        ...
        self.time_s2_lbl_2.setText(_translate("Form", "Time:"))
        ...
        self.time_s3_lbl_2.setText(_translate("Form", "Time:"))
        ...
        if c.is_open() == 1:
            ...
            for i in range(0, 10):
                ...
                #Check the values of sensor 3        
                    ...
                    if self.mask1[i] == 0:
                        self.state_s1_lbl.setText("OK")
                        
                    elif self.mask1[i] > 0:
                        self.state_s1_lbl.setText("Warning")

                    if self.mask2[i] == 0:
                        self.state_s1_lbl.setText("OK")  
                    elif self.mask2[i] > 0:
                        self.state_s1_lbl.setText("Error")

                elif i == 4:
                    if self.mask1[i] == 0:
                        self.state_s2_lbl.setText("OK")
                        
                    elif self.mask1[i] > 0:
                        self.state_s2_lbl.setText("Warning")

                    if self.mask2[i] == 0:
                        self.state_s2_lbl.setText("OK")  
                    elif self.mask2[i] > 0:
                        self.state_s2_lbl.setText("Error")

                elif i == 5:
                    if self.mask1[i] == 0:
                        self.state_s3_lbl.setText("OK")
                        
                    elif self.mask1[i] > 0:
                        self.state_s3_lbl.setText("Warning")

                    if self.mask2[i] == 0:
                        self.state_s3_lbl.setText("OK")  
                    elif self.mask2[i] > 0:
                        self.state_s3_lbl.setText("Error")


                elif i == 6:
                    self.time_s1_lbl.setText(self.regs_old[i])

                elif i == 7:
                    self.time_s2_lbl.setText(self.regs_old[i])

                elif i == 8:
                    self.time_s3_lbl.setText(self.regs_old[i])
